            ...
            <div className=" flex gap-2   min-h-fit">
                ...
                <div className="w-full flex flex-col">
                    <div className="w-full border-b border-gray-800 min-h-fit ">
                        <TextareaAutosize
                            placeholder={` ${type === "post" ? "What is happening?!" : "Ask a question"
                                }`}
                                            ...
                                            {Array(totalOptions)
                                                ...
                                                .map((_, index) => (
                                                    <input
                                                        ...
                                                        placeholder={`Option ${index + 1}${index + 1 > 2 ? "(optional)" : ""
                                                            } `}
                                                        onChange={(
                                                            e: React.ChangeEvent<HTMLInputElement>
                                                        ) =>
                    ...
                    <div className="flex gap-1 p-2 items-center h-full ">
                        <CustomTooltip title="Media">
                            <button
                                className={`rounded-full    ${type === "poll"
                                    ? " cursor-default"
                            ...
                            >
                                <label
                                    htmlFor="file-upload"
                                    className={`${type === "poll" ? " cursor-default" : " cursor-pointer"
                                        }`}
                                >
                                    <ImageIcon
                                        className={`size-5  m-2 ${type === "poll" ? "text-gray-400/70" : "text-blue-400"
                                            }`}
                                    />
                                </label>
                            </button>
                        ...
                        <CustomTooltip title="Video">
                            <button
                                className={`rounded-full p-2 ${type === "poll"
                                    ? " cursor-default"
                            ...
                            >
                                ...
                                >
                                    <VideoIcon
                                        className={`size-5  ${type === "poll" ? "text-gray-400/70" : "text-blue-400"
                                            } `}
                                    />
                                </label>
                            </button>
                        ...
                        {textareaValue ? (
                            <div
                                className={`ml-auto lg:size-7 size-5 md:size-6  text-xs flex justify-center items-center  bg-green-600 rounded-full ${textareaValue && textareaValue.length >= 280
                                    ? "bg-red-600"
                                    : "bg-green-600"
                                    }`}
                            >
                        ...
                        <button
                            className={`rounded-full p-2 px-4 text-semibold bg-blue-400 hover:opacity-90 ml-auto ${isPending || pendingPoll ? "bg-gray-500" : ""
                                }`}
