            ...
            <div className="flex flex-col py-5 gap-y-1 ">
                <div className="group w-full cursor-pointer ">
                    ...
                    >
                        ...
                        <span
                            className={` ${currentlyOn === "home" ? "font-bold" : ""
                ...
                <div className="group w-full cursor-pointer ">
                    ...
                    >
                        ...
                        <span
                            className={` ${currentlyOn === "search" ? "font-semibold" : ""
                ...
                <div className="group w-full cursor-pointer ">
                    <button
                        className={`${currentlyOn === "notifications" ? "font-semibold" : ""
                    ...
                    >
                        <BellIcon
                            className={`size-6 ml-2 shrink-0   ${currentlyOn === "notifications" ? "fill-white" : ""
                                } `}
                        />
                ...
                <div className="group w-full cursor-pointer ">
                    ...
                    >
                        ...
                        <span
                            className={`${currentlyOn === "profile" ? "font-semibold" : ""
                                }  text-xl rounded-full rounded-r-none select-none   `}
                        >
                            Profile
                        </span>
                ...
                <div className="group w-full cursor-pointer ">
                    ...
                    >
                        <Bookmark
                            className={`size-7 ml-2 shrink-0 ${currentlyOn === "bookmarks" ? "fill-white" : ""
                                }`}
                        />
                        <span
                            className={`${currentlyOn === "bookmarks" ? "font-semibold " : ""
                                }  text-xl rounded-full rounded-r-none select-none   `}
                        >
                            Bookmarks
                        </span>
                ...
                <div className="group w-full cursor-pointer ">
                    ...
                    >
                        ...
                        <span
                            className={`${currentlyOn === "connect_people" ? "font-semibold" : ""
                                }  text-xl rounded-full rounded-r-none select-none   `}
                        >
                            Suggestions
                        </span>
                ...
                <div className="group w-full cursor-pointer ">
                    <button
                        className={`${currentlyOn === "more" ? "font-semibold" : ""
                ...
                <div className="group w-full cursor-pointer ">
                    <button
                        className={`${currentlyOn === "settings" ? "font-semibold" : ""
                            }  flex justify-start cursor-pointer   gap-4 group-hover:bg-gray-800/50  w-fit p-3 pr-6 rounded-full transition-colors `}
                        onClick={() => {
            ...
            <Popover>
                <PopoverTrigger className="  mt-auto ">
                    <div className=" mt-auto flex items-center  gap-2 p-2 mx-2 group-hover:bg-gray-800/50 transition-colors cursor-pointer rounded-full">
                        ...
                        <button className=" h-fit w-fit shrink-0 ml-auto mr-1  hidden lg:block ">
                ...
                <PopoverContent className="bg-black text-white p-0 border-none shadow-sm   ring-1 shadow-white">
                    <button
                        className="font-bold w-full hover:bg-white/10 p-4 cursor-pointer active:bg-red-600/50 rounded-md select-none"
                        onClick={() => logout()}
                    >
                        Logout
                    </button>
