...
const { createPost, getPosts,getProfilePost, commentOnPost,getPost, postOfFollowing, likePost, getLikedPosts,deletePost,likeComment, deleteComment, createPoll} = require("../controllers/postControllers");

router.post("/createpost",protectRoute,upload.single('uploadedPhoto'),createPost);
router.post("/createpoll",protectRoute,upload.single("explanationImage"),createPoll)
